function main() {
  ...
  let dataEntrada = document.querySelector(`input#start_date`);
  let dataSaida = document.querySelector(`input#end_date`);
  let dataInicio = (dataEntrada.value);
  let dataFim = (dataSaida.value);

  dataEntrada = new Date(dataInicio);
  dataSaida = new Date (dataFim);
